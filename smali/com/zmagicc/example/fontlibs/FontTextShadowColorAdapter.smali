.class public Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$b;,
        Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$a;
    }
.end annotation
...
.field public d:Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, v0, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;->b:[Ljava/lang/String;

    const/4 v1, -0x1

    .line 3
    iput v1, v0, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;->c:I

    move-object/from16 v1, p1

    .line 4
    iput-object v1, v0, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;->a:Landroid/content/Context;
...
# virtual methods
.method public a(Landroid/view/ViewGroup;)Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$a;
    .locals 3
    ...
    .line 1
    iget-object v0, p0, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;->a:Landroid/content/Context;
    ...
    .line 2
    new-instance v0, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$a;

    invoke-direct {v0, p1}, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$a;-><init>(Landroid/view/View;)V
...
.method public getItemCount()I
    ...
    .line 1
    iget-object v0, p0, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;->b:[Ljava/lang/String;
...
.method public onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    .line 1
    check-cast p1, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$a;

    .line 2
    iget-object v0, p1, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$a;->b:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;->b:[Ljava/lang/String;
    ...
    new-instance v1, Lc/n/d/w;

    invoke-direct {v1, p0, p2}, Lc/n/d/w;-><init>(Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;I)V

    invoke-virtual {v0, v1}, Landroid/widget/ImageView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 4
    iget v0, p0, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;->c:I

    if-ne v0, p2, :cond_1

    .line 5
    iget-object p2, p0, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;->a:Landroid/content/Context;
    ...
    .line 6
    iget-object p1, p1, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$a;->c:Landroid/view/View;
...
.method public bridge synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;->a(Landroid/view/ViewGroup;)Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$a;
...
.method public setOnColorItemClickListener(Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$b;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter;->d:Lcom/zmagicc/example/fontlibs/FontTextShadowColorAdapter$b;
